...
subjects = Subject.create([
	...
	{name: "Rails", icon: "rails2.png", description: "Server-side web application framework written in Ruby under the MIT License. Rails is a model–view–controller (MVC) framework"},
	...
	{name: "MVC", icon: "mvc.jpg", description: "Model View Controller, an architectural pattern dividing applications into three interconnected parts to separate data from the way it is presented to the user"},
